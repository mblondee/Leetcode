...
public class test_leetcode21_40 {
    ...
    public void testGenerateParentheses(){
        Assert.assertEquals(2, GenerateParentheses.generateParenthesis(2).size());
        Assert.assertEquals(5, GenerateParentheses.generateParenthesis(3).size());
    }
...
/*    @Test
    ...
    public void testImplementstrStr(){
        ...
        Assert.assertEquals(2, ImplementstrStr.strStr("hellohellohello", "ll"));
        Assert.assertEquals(2, ImplementstrStr.strStr("hellllllo", "ll"));
        Assert.assertEquals(-1, ImplementstrStr.strStr("hello", "le"));
        Assert.assertEquals(0, ImplementstrStr.strStr("hello", ""));
        Assert.assertEquals(3, ImplementstrStr.strStr("hello", "lo"));
    }
    ...
    public void testKMPArray(){
        ...
        Assert.assertArrayEquals(result1, ImplementstrStr.computeArray(input1));
        ...
        Assert.assertEquals(2, ImplementstrStr.strStrKMP("hello", "ll"));
        Assert.assertEquals(2, ImplementstrStr.strStrKMP("hellohellohello", "ll"));
        Assert.assertEquals(2, ImplementstrStr.strStrKMP("hellllllo", "ll"));
        Assert.assertEquals(-1, ImplementstrStr.strStrKMP("hello", "le"));
        Assert.assertEquals(0, ImplementstrStr.strStrKMP("hello", ""));
        Assert.assertEquals(3, ImplementstrStr.strStrKMP("hello", "lo"));
    ...
    public void testDivision(){
        int n = 90;
        int d = 30;
        Assert.assertEquals(3, DivideTwoIntegers.divide(n,d));

        Assert.assertEquals(3, DivideTwoIntegers.divide(91,30));
        Assert.assertEquals(0, DivideTwoIntegers.divide(9,30));

        Assert.assertEquals(-15, DivideTwoIntegers.divide(45,-3));
        Assert.assertEquals(32, DivideTwoIntegers.divide(64,2));

        Assert.assertEquals(Integer.MAX_VALUE, DivideTwoIntegers.divide(Integer.MAX_VALUE, 1));

        Assert.assertEquals(Integer.MAX_VALUE, DivideTwoIntegers.divide(Integer.MIN_VALUE, -1));
        Assert.assertEquals(Integer.MIN_VALUE, DivideTwoIntegers.divide(Integer.MIN_VALUE, 1));
        Assert.assertEquals(Integer.MIN_VALUE, DivideTwoIntegers.divide(Integer.MAX_VALUE, -1));

        Assert.assertEquals((Integer.MAX_VALUE)/2, DivideTwoIntegers.divide(Integer.MAX_VALUE, 2));
        Assert.assertEquals((Integer.MIN_VALUE)/2, DivideTwoIntegers.divide(Integer.MIN_VALUE, 2));
        Assert.assertEquals((Integer.MIN_VALUE)/(-2), DivideTwoIntegers.divide(Integer.MIN_VALUE, -2));

        Assert.assertEquals(1, DivideTwoIntegers.divide(Integer.MAX_VALUE, Integer.MAX_VALUE));
        Assert.assertEquals(0, DivideTwoIntegers.divide(Integer.MAX_VALUE, Integer.MIN_VALUE));
        Assert.assertEquals(-1, DivideTwoIntegers.divide(Integer.MIN_VALUE, Integer.MAX_VALUE));
        Assert.assertEquals(1, DivideTwoIntegers.divide(Integer.MIN_VALUE, Integer.MIN_VALUE));
    ...
    public void testSubstringConcatenation(){
        ...
        Assert.assertEquals(0, SubstringConcatenation.findSubstring("", w2).size());
    ...
    public void testSearchRotatedSortedArray(){
        ...
        Assert.assertEquals(-1, SearchRotatedSortedArray_33.search(test1, -1));
        Assert.assertEquals(2, SearchRotatedSortedArray_33.search(test1, 0));
        Assert.assertEquals(3, SearchRotatedSortedArray_33.search(test1, 1));
        Assert.assertEquals(4, SearchRotatedSortedArray_33.search(test1, 2));
        Assert.assertEquals(-1, SearchRotatedSortedArray_33.search(test1, 3));
        Assert.assertEquals(5, SearchRotatedSortedArray_33.search(test1, 4));
        Assert.assertEquals(6, SearchRotatedSortedArray_33.search(test1, 5));
        Assert.assertEquals(0, SearchRotatedSortedArray_33.search(test1, 6));
        Assert.assertEquals(1, SearchRotatedSortedArray_33.search(test1, 7));
        Assert.assertEquals(-1, SearchRotatedSortedArray_33.search(test1, 8));

        int[] test2 = {8,7};
        Assert.assertEquals(0, SearchRotatedSortedArray_33.search(test2, 8));
        Assert.assertEquals(1, SearchRotatedSortedArray_33.search(test2, 7));
        Assert.assertEquals(-1, SearchRotatedSortedArray_33.search(test2, 0));

        int[] test3 = {8};
        Assert.assertEquals(0, SearchRotatedSortedArray_33.search(test3, 8));
        Assert.assertEquals(-1, SearchRotatedSortedArray_33.search(test3, 7));

        int[] test4 = {};
        Assert.assertEquals(-1, SearchRotatedSortedArray_33.search(test4, 7));
    }
    ...
    public void testFirstLastPosition(){
        ...
        Assert.assertArrayEquals(new int[]{3,4}, FirstLastPosition.searchRange(nums1,8));
        Assert.assertArrayEquals(new int[]{0,0}, FirstLastPosition.searchRange(nums1,5));
        Assert.assertArrayEquals(new int[]{1,2}, FirstLastPosition.searchRange(nums1,7));
        Assert.assertArrayEquals(new int[]{-1,-1}, FirstLastPosition.searchRange(nums1,300));

        Assert.assertArrayEquals(new int[]{-1,-1}, FirstLastPosition.searchRange(new int[]{},300));
        Assert.assertArrayEquals(new int[]{0,0}, FirstLastPosition.searchRange(new int[]{1},1 ));
    ...
    public void testSearchInsert(){
        ...
        Assert.assertEquals(1, SearchInsertPosition.searchInsert(nums1, 7));
        Assert.assertEquals(1, SearchInsertPosition.searchInsert(nums1, 6));
        Assert.assertEquals(0, SearchInsertPosition.searchInsert(nums1, 4));
        Assert.assertEquals(3, SearchInsertPosition.searchInsert(nums1, 9));
        Assert.assertEquals(4, SearchInsertPosition.searchInsert(nums1, 11));
        Assert.assertEquals(5, SearchInsertPosition.searchInsert(nums1, 13));
    }
